...
#   [ 0, 1, 1, 0 ]
# ]
# A one indicates that a connection is true and a zero indicates a connection is false.Here is how the above model might be written out:
...
def adjacency_matrix(a, x, y, rows, columns):
    if rows * columns > 25000:
        return ("Out of range")
    elif a[x][y]== 1:
        return True
    else:
...
print(adjacency_matrix(a, x, y, rows, columns))